## How to insert data into table which has a foregin key in it
## Here the foreign key are set as NULL as the related values has not been created 
INSERT INTO employee VALUES(100,'David','Walace','1967-11-17','M',2500000,NULL,NULL);
# Inserting data into the related table
INSERT INTO branch VALUES (1,'Corporate',100,'2006-02-09');
# Updating the initial table 
UPDATE employee
SET branch_id = 1
WHERE emp_id = 100;
# Entering data into the initial table having the same value as the initail entry
